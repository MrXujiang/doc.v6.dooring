...
///////////////////
export interface IFileListConfigType {
  key: string;
  name: string;
  type: 'FileList';
}

export type TFileListDefaultTypeItem = {
  id: string;
  name: string;
  flag: string;
  url: string;
...
export type TFileListDefaultType = Array<TFileListDefaultTypeItem>;

////////////////////
export interface IInteractionConfigType {
  key: string;
  name: string;
  type: 'InteractionData';
}

export type TInteractionDefaultType = {
  type: string;
  title: string;
  content: any;
  height: number;
...
export type baseFormCascadeTpl = {
  id: string;
  type: 'MyCascade';
  label: string;
  placeholder: string;
...
export type baseFormUnionType =
  ...
  | baseFormCascadeTpl['type']
  | baseFormUploadTpl['type'];
